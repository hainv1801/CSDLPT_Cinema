...
public class SecurityUtil {
    ...
    // Tạo Access Token
    public String createAccessToken(String taiKhoan, ResLoginDTO dto) {
        ...
        // Lấy vai trò (ROLE) của user để đưa vào token
        List<String> listAuthority = new ArrayList<>();
        listAuthority.add("ROLE_" + dto.getUser().getVaiTro());
    ...
    // Tạo Refresh Token
    public String createRefreshToken(String taiKhoan, ResLoginDTO dto) {
        Instant now = Instant.now();
    ...
    // Lấy thông tin user đang đăng nhập (dùng cho @PrePersist trong Entity)
