...
public class NguoiDungService {
    ...
    public ResultPaginationDTO fetchAllUser(Specification spec, Pageable pageable) {
        Page<NguoiDung> pageUser = this.nguoiDungRepository.findAll(spec, pageable);
    ...
    public NguoiDung findById(int id) {
        Optional<NguoiDung> optional = this.nguoiDungRepository.findById(id);
        return optional.isPresent() ? optional.get() : null;
    }

    public NguoiDung updateUserRole(int id, String role) {
        NguoiDung userDB = this.findById(id);
        userDB.setVaiTro(role);
        return this.nguoiDungRepository.save(userDB);
    }
}
